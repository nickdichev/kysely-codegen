...
export declare class ExportStatementNode {
    readonly argument: AliasDeclarationNode | InterfaceDeclarationNode | EnumDeclarationNode | TypeAliasDeclarationNode;
    readonly type = "ExportStatement";
    constructor(argument: AliasDeclarationNode | InterfaceDeclarationNode | EnumDeclarationNode | TypeAliasDeclarationNode);
}
