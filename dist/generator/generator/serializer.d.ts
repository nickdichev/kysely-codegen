...
export declare class TypeScriptSerializer implements Serializer {
    ...
    serializeEnum(node: EnumDeclarationNode): string;
    serializeRuntimeEnumContent(node: EnumDeclarationNode): string;
    serializePojoEnumContent(node: EnumDeclarationNode): string;
    serializeTypeAliasDeclaration(node: TypeAliasDeclarationNode): string;
